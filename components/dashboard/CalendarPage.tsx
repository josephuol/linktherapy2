...
const CalendarPage: React.FC = () => {
  ...
  const handleEventClick = (clickInfo: EventClickArg) => {
    ...
    setEventStartDate(clickInfo.event.start?.toISOString().split("T")[0] || "");
    setEventEndDate(clickInfo.event.end?.toISOString().split("T")[0] || "");
  ...
  return (
    <div className="rounded-2xl border  border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="custom-calendar relative z-10">
        <FullCalendar
          ref={calendarRef}
      ...
      <Modal
        isOpen={isOpen}
        onClose={closeModal}
        className="max-w-[700px] p-6 lg:p-10 z-[100000]"
      >
